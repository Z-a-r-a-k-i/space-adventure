...
param(
    ...
    [ValidateSet("all", "ready", "draw", "armed", "armed-walk", "fire", "recoil", "anticipation", "contact", "barrier", "barrier-block", "facing", "taunt", "burst", "interrupt", "late-fire", "holster", "victory", "slice-complete", "defeat", "retry")]
