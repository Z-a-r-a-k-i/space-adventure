# Operator pistol turnaround v1 — provenance
...
- File: `operator-pistol-turnaround-v1.png`
...
This is the approved Operator-pistol visual anchor, not a production-ready
asset brief.
...
Constraints: identical geometry, colors, vents, grip, muzzle, and asymmetry in all views; holster-friendly compact silhouette; broad shapes and clear separable hard-surface parts suitable for Tripo reference and Blender cleanup; no logos, letters, numbers, labels, dimensions, watermark, scenery, projectile, muzzle flash, hologram, or extra weapon
Avoid: modern real-world handgun copying, long sniper barrel, revolver cylinder, oversized optic, fantasy ornament, excessive rails, tiny noisy greebles, white ceramic sci-fi gun, toy proportions, warped orthographic views
```

## Review boundary

Approval covers the pistol's compact silhouette, proportions, palette, grip,
muzzle, and major part boundaries. The complete Operator assembly must still
validate hand fit, aim line, tactical readability, and final holster clearance.
