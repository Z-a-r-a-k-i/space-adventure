# POC model visual-approval queue

Status: active reference-sheet queue
...
| 8 | `character.npc.station_survivor.v1` | Four-view character turnaround and dialogue silhouette | Queued |
| 9 | `machine.security.ram_drone.v1` | Complete-machine turnaround plus brace, contact, and rebound silhouettes | Queued |
| 10 | `machine.security.gun_sentry.v1` | Complete-machine turnaround plus aim and recoil silhouettes | Queued |
| 11 | `prop.station.wall_utility.v1` | Front, mounting-depth side, top, and three-quarter views | Queued |
| 12 | `item.healing.field_aid.v1` | Hand-scale form alternatives followed by one selected turnaround, only if visible 3D handling is retained | Conditional |
| 13 | `kit.station.structure.v1` | Multi-piece orthographic module sheet plus assembled cutaway example | Queued; Blender-authored, not Tripo |
| 14 | `assembly.station.evacuation_airlock.v1` | Part sheet plus closed/open-state sheet | Queued; structural parts Blender-authored |
